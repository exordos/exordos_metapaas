...
from metapaas_demo import constants as c
...
class DemoInstance(models.DemoInstance, ua_models.InstanceWithDerivativesMixin):
    ...
    OnReloadFunc = sdk_models.OnChangeShell(
        command="systemctl restart exordos-metapaas-demo-configure"
    )
